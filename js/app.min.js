...
var github = function () {
    ...
    switch (userLang) {
      case "es":
        console.log('Hola si le interesa ver el código check mi github aquí ------> https://github.com/ErwanEL/showLocalWeatherDev/tree/master/src/js');
        break;
  
      case "fr":
        console.log('Pour voir le code rendez vous sur mon github ------> https://github.com/ErwanEL/showLocalWeatherDev/tree/master/src/js');
        break;
  
      case "en":
        console.log('To see the code check mi github here ------> https://github.com/ErwanEL/showLocalWeatherDev/tree/master/src/js');
        break;
  
      default:
        console.log('Si le interesa ver el código check mi github aquí ------> https://github.com/ErwanEL/showLocalWeatherDev/tree/master/src/js');
        break;
    }
  }();